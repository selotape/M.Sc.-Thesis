...
The denominator, which is the joint genealogy and parameter likelihoods, is constantly calculated by gphocs as part of the MCMC flow. the enumerator then is what remains to be calculated for all $\{\GT^{(i)}\}$. 
