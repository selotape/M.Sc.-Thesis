...
Where $\Ip$ is the set of intervals between coalescence events in population $p$ in the genealogy over locus $l$ in MCMC iteration $i$ and $\Ib$ is the set of intervals between migration events in migration band $b$, and $t_I$ is the time span of interval $I$.
