...
Collapsing is the process of merging the populations of a subtree. \textbf{Clade-Collapsing} is the act of the merging all the populations of a subtree rooted at some population $P$ into a single population. This new population contains the portion of the genealogies previously located inside the subtree. We denote the resulting merged population $clade(P)$. Figure $(\ref{fig:clade_collapse_AB})$ illustrates a clade-collapsing of a subtree rooted at $AB$ into a new population, $clade(AB)$. 
...
\item We then map the hidden parameters of $\M$ onto parameters of $\Mref$ to define the model-pairing conditional $\Pref$ (see section ASDF).
\end{enumerate}
