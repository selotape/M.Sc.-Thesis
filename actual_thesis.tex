...
\begin{enumerate}
\item We First "collapse" some subtree of the hypothesis. Collapsing is the process of merging the populations of the subtree.  Denote $clade(p)$ as a population which is the result of merging all the populations of the subtree rooted at $p$ into a single population. Similiarly $comb(p)$ will denote collapsing the subtree rooted at $p$ but perserving it's leaves up to the comb-age.
