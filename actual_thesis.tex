...
%
To calculate summary statistics for all poossible clades in an efficient manner, calculation is done recursively down the hypothesis population tree, starting from the root. The following pseudo-python calculates $numCoals$ and $coalStats$ of a clade using preexisting data from \gp (\pythoninline{num_coals_from_gphocs} and \pythoninline{intervals_from_gphocs}) and a statistical utility for calculating $coalStats$ of a set of sorted intervals (\pythoninline{calculate_coal_stats}):
%
