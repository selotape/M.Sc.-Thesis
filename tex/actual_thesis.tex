...
%
These values are taken as-is from \gp and utilized as explained in section \ref{sec:Finalizing the RBF computation}.
%
%
The parameter priors $P(\troot|\M)$ and $P(\theta_0=\troot|\M_0)$ usually share the same distribution so calcel out. 
%
otherwise, $P(\troot|\M)$ is taken from \gp as-is and $P(\theta_0=\troot|\M_0)$ is calculated as described in subsection \ref{sec:Finalizing the RBF computation}.
%
%
...
%
We consider this the main component making up the model pairing conditional, as it represents the bulk of our computational challenge. The rest of section \ref{sec:RBF Computational Scheme} details it's calculation in an efficient manner.
...
%
Subsections \ref{sec:Recursive Sufficient Statistics for All Clade Models} and \ref{sec:Recursive Sufficient Statistics for All Comb Models} explain how this is efficiently extended to multiple reference model structure.
%
Section \ref{sec:Finalizing the RBF computation} then explains how the intermediate sufficient statistics are finalized into an RBF of a specific reference model.
...
\label{Recursive Sufficient Statistics for All Clade Models}
...
\section{Finalizing the RBF computation}
